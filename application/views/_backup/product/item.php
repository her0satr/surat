<?php
	...
	$array_catalog = $this->Catalog_model->get_array();
						...
						<div class="span12">
							<form class="form-horizontal">
								...
								<div class="span7">
									...
									<div class="control-group">
										<label class="control-label" for="input_stock">Stock</label>
										<div class="controls">
											<input type="text" id="input_stock" name="stock" placeholder="Stock Item" class="span12" rel="twipsy" data-placement="right" data-original-title="Stock Item" />
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="input_stock_min">Stock Min</label>
										<div class="controls">
											<input type="text" id="input_stock_min" name="stock_min" placeholder="Stock Min Item" class="span12" rel="twipsy" data-placement="right" data-original-title="Stock Min Item" />
										</div>
									</div>
									<div class="control-group">
								...
								<div class="span4">
									...
									<div class="control-group" id="picture-upload">
										<label class="control-label" for="input_price">Upload</label>
										<div class="controls">
											<div class="upload_multi">
												<div class="upload-list">
													<div class="item">
														<div class="picture"><img src="http://localhost:8666/shop/trunk/static/upload/2013/04/22/photo-45.jpg" /></div>
														<div class="delete"><img src="http://localhost:8666/shop/trunk/static/img/delete.png" alt="Delete Picture" title="Delete Picture" /></div>
													</div>
												</div>
												<div class="clear"></div>
												<iframe frameborder="0" class="iframe" src="<?php echo site_url('panel/upload/upload_single?callback=image_item'); ?>"></iframe>
											</div>
										</div>
									</div>
								</div>
            ...
            function init_table() {
                ...
                $('#item-grid').on('click','tbody td img.edit', function () {
					...
					Func.ajax({ url: web.host + 'panel/product/item/action', param: param, callback: function(record) {
						...
						$('#form-item [name="category"]').val(record.category);
						/*	*/
