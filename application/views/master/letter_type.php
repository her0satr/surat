<?php
	$array_menu = array( 'menu' => array('Master', 'Jenis Surat') );
			...
			<div class="modal-body" style="padding-left: 0px;">
				...
				<form class="form-horizontal" style="padding-left: 0px;">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="input_name" name="name" placeholder="Nama Jenis Surat" class="span5" rel="twipsy" />
                        </div>
                    </div>
                </form>
            </div>
	...
	<script>
		$(document).ready(function() {
			...
			$('#WinLetterType .save').click(function() {
				...
				Func.ajax({ url: web.base + 'master/letter_type/action', param: param, callback: function(result) {
			...
			function init_table() {
				grid_letter = $('#grid-letter').dataTable( {
					...
					"sAjaxSource": web.base + 'master/letter_type/grid',
				...
				$('#grid-letter').on('click','tbody td img.delete', function () {
					...
					Func.confirm_delete({
						...
						url: web.base + 'master/letter_type/action',
						grid: grid_letter
                    });
                });
            }
